const PRODUCTS = [
  ...
  { id: "easyup-compact", name: "Dandle EasyUp Compact", price: 28000, outcome: "easier standing in a smaller space", audience: ["stand", "standing", "mobility", "senior", "والد", "والدة", "كبير", "حركة", "وقوف"], facts: ["power lift", "compact format", "zero-gravity positioning"] },
  ...
  { id: "easyup", name: "Dandle EasyUp Power", price: 35000, outcome: "a dignified, easier rise", audience: ["stand", "standing", "mobility", "senior", "والد", "والدة", "كبير", "حركة", "وقوف"], facts: ["power lift", "zero-gravity positioning", "easy-clean fabric"] },
...
export function createNourReply({ message = "", journey = {}, source = {} } = {}) {
  ...
  const isFollowUp = /price|cost|compare|those|them|whatsapp|human|sales|كام|سعر|قارن|مقارنة|دول|واتساب|حد يكلمني|مندوب/.test(text.toLowerCase());
